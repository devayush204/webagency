...
<footer className="bg-white z-10 w-full mt-10">
  <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div
      className="flex flex-col items-center gap-4 rounded-3xl bg-purple-600 p-6 shadow-lg sm:flex-row sm:justify-between"
    >
