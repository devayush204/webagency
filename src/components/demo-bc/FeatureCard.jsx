...
function FeatureCard({ icon, title, description }) {
  return (
    <div className="flex overflow-hidden flex-1 shrink gap-2.5 items-center self-stretch py-8 pr-8 pl-7 my-auto rounded-2xl border border-solid backdrop-blur-[100px] basis-0 bg-white bg-opacity-0 border-white border-opacity-10 min-w-[240px] max-md:px-5">
      <div className="flex flex-col flex-1 shrink self-stretch my-auto w-full basis-0">
        ...
        <button className="flex gap-1 items-center self-start mt-10 text-base font-medium text-teal-500">
